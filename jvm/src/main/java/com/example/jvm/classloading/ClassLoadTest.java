...
public class ClassLoadTest {
    ...
    public static void main(String[] args) throws Exception {
        ...
        Object obj = myLoader.loadClass("com.example.jvm.classloading.ClassLoadTest").newInstance();
        System.out.println(obj.getClass());
        System.out.println(obj instanceof com.example.jvm.classloading.ClassLoadTest);
    }
}
